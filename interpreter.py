...
class Device(object):
    ...
    def __call__(self, *args):
        ...
        try:
            ...
            raise ActionNotAvailable('!!! "{}" not available for {}'
        ...
        if arity != num_args - 1:
            ...
            err_msg = '!!! "{}" on {} must be defined with {}'\
                .format(action, self.__class__.__name__, substring)
...
class Interpreter(object):
    ...
    def interpret(self, input_string):
        ...
        try:
            ...
            raise DeviceNotAvailable('!!! {} is not available an available '
                                     'device'.format(dev_str))
        else:
