...
class Process(object):
    ...
    def __init__(self, name):
        ...
        # add transitions
        self.machine.add_transition(trigger='wake_up', source='sleeping',
                                    dest='waiting')
        self.machine.add_transition(trigger='start', source='waiting',
                                    dest='running', before='display_message')
        self.machine.add_transition(trigger='interrupt', source='*',
